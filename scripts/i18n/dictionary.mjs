...
export const dictionary = [
  ...
  ['Actualizare site', 'Site updates'],
  ['Texte pentru Google', 'Google copy'],
  ['Configurare Analytics', 'Analytics setup'],
  ['Pornire Google Ads', 'Google Ads launch'],
  ['Postări pe Facebook', 'Facebook posts'],
  ['Apariție în căutări', 'Search visibility'],
  ['Site pe telefon', 'Mobile site'],
  ['Imagini comprimate', 'Compressed images'],
  ['Pagină de landing', 'Landing page'],
  ['Răspuns la review-uri', 'Review replies'],
  ['Schimbare de hosting', 'Hosting change'],
  ['Backup la site', 'Site backup'],
  ['Sitemap către Google', 'Sitemap to Google'],
  ['Verificare formular', 'Form check'],
  ['Magazin care vinde', 'A store that sells'],
  ['Pixel de Facebook', 'Facebook pixel'],
  ['Conectare domeniu', 'Domain connection'],
  [
    'Testare campanie înainte de bani arși',
    'Campaign testing before the budget burns',
  ],
  [
    'Pagină de contact care aduce apeluri',
    'Contact page that brings calls',
  ],
  ['Site scos din „în construcție”', 'Site out of “under construction”'],
  ['Agenția trecută a livrat un template', 'The last agency shipped a template'],
  ['Asta chiar îmi aduce clienți?', 'Is this actually bringing me clients?'],
  ['Pe telefon arată groaznic', 'It looks awful on a phone'],
  ['Am mai ars o dată cu ads', 'I have been burned on ads before'],
  ['N-am timp de treaba asta', 'I do not have time for this'],
  ['Raportul e verde, telefonul tace', 'The report is green, the phone is quiet'],
  [
